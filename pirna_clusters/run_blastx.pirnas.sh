...
QUERY="/data/scripts/slugsTE/data/explore_pirna_cluster/top20_pirna_clusters_sequences.fasta"
GENOME_DIR="/data/genomes"
OUT_DIR="/data/scripts/slugsTE/data/explore_pirna_cluster/blastn_vs_genomes"
